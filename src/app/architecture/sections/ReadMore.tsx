      ...
      <div className="read-more">
        <Link href={TECHNICAL_PATH}>
          ...
          <span className="muted small">
            Hur låset och kuverten är byggda, vad som publiceras, vilka spår systemet lämnar och
            alla kända begränsningar.
          </span>
        </Link>
        <Link href={STATUS_PATH}>
          <strong>Utvecklingsstatus</strong>
          <span className="muted small">
            Vad som är byggt och inte, vad det gamla röstflödet fortfarande gör och vad som återstår.
          </span>
        </Link>
      </div>
    </section>
